...
function SubjectCard({
  ...
  return (
    ...
    <motion.div
      ...
      className={cn(
        "glass-panel rounded-3xl p-5 relative transition-all duration-500",
          ...
          <AnimatePresence>
            {showOptions && (
              <motion.div
                ...
                className="absolute left-0 top-full mt-1 bg-popover border border-white/10 rounded-xl shadow-xl z-50 overflow-hidden min-w-[130px]"
              >
                <button
                  onClick={() => {
